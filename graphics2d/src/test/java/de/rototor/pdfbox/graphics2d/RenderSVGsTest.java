...
public class RenderSVGsTest extends PdfBoxGraphics2DTestBase {
	...
	private void renderSVGCMYK(String name, final double scale) throws IOException, FontFormatException {
		String uri = String.valueOf(RenderSVGsTest.class.getResource(name));
		...
		try {
			...
			contentStream.setFont(new PDType1Font(FontName.HELVETICA_BOLD), 15);
